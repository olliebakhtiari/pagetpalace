...
LIVE_ACCESS_TOKEN = _PAGETPALACELIVE['ACCESS_TOKEN']
DEMO_ACCESS_TOKEN = _PAGETPALACEDEMO['ACCESS_TOKEN']

# Live.
EUR_GBP_ACCOUNT_NUMBER = _PAGETPALACELIVE['EUR_GBP_ACC_NUM']
GBP_USD_ACCOUNT_NUMBER = _PAGETPALACELIVE['GBP_USD_ACC_NUM']
HAMMER_PIN_POOL_ACCOUNT_NUMBER = _PAGETPALACELIVE['HAMMER_PIN_POOL_ACC_NUM']
NAS100_ACCOUNT_NUMBER = _PAGETPALACELIVE['NAS100_ACC_NUM']
PRIMARY_ACCOUNT_NUMBER = _PAGETPALACELIVE['PRIMARY_ACC_NUM']
SPX500_ACCOUNT_NUMBER = _PAGETPALACELIVE['SPX500_ACC_NUM']
